            ...
            <el-table :data="userlist" border stripe>
                ...
                <el-table-column label="操作" width="200px">
                    <template slot-scope="scope">
                        ...
                        <!-- 分配角色按钮 -->
                        <!-- el-tooltip 这个标签里面按钮上面会有提文字示信息写在content里面 -->
        ...
        methods: {
            async getUserList() {
                const {
                    ...
                    // this.queryInfo该参数已经在上面data中定义了内容
                })
                if (res.meta.status !== 200) {
                    // meta.status是后台服务器给的data中的meta中的一个数据，200表示成功
            ...
            async removeUserById(id) {
                ...
                const confirmResult = await this.$confirm(
                    // this.$confirm是element ui 提供的，通过全局注册可以用this.$confirm直接使用
                    '此操作将永久删除该用户, 是否继续?',
                    '提示', {
